...
#define UMSocial_Name_Label_Height 13
...
- (void)subviewsUpdate
{
    self.logoImageView.frame = CGRectMake((self.width-kScaleX(40))/2, 0,kScaleX(40), kScaleX(40));
    self.platformNameLabel.frame = CGRectMake(0,kScaleX(40)+8, self.width, UMSocial_Name_Label_Height);
}
