//
//  OriginalEaseConversationListViewController.m
//  WanQuan-iOS
//
...
@interface OriginalEaseConversationListViewController ()

@end

@implementation OriginalEaseConversationListViewController
...
//        EaseMessageViewController *viewController = [[EaseMessageViewController alloc] initWithConversationChatter:model.conversation.conversationId conversationType:model.conversation.type];
        ...
        EaseMessageViewController * viewController = [[EaseMessageViewController alloc] initWithConversationChatter:model.conversation.conversationId conversationType:EMConversationTypeChat needId:nil needOwnerId:nil fromName:nil fromPic:nil toName:nil toPic:nil isFromTemp:nil isTrueName:YES isBidTureName:YES];
