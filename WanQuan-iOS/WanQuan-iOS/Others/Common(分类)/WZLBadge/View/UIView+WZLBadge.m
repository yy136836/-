...
- (void)badgeInit
{
    ...
    if (nil == self.badge) {
        ...
        self.badge.center = CGPointMake(CGRectGetWidth(self.frame) + 2 + self.badgeCenterOffset.x, self.badgeCenterOffset.y + 3);
        ...
        self.badge.hidden = NO;
        self.badge.center = CGPointMake(self.badge.centerX - 10, self.badge.centerY + 5);
