...
//  WanQuan-iOS
//
//  Created by hanyang on 2017/10/27.
//  Copyright © 2017年 WQ. All rights reserved.
//

#import <Foundation/Foundation.h>

@interface WQGroupBaseInfo : NSObject
...
/**
 true boolean 是否禁用邀请码
 */
@property (nonatomic, assign) BOOL invite_disable;
@end
