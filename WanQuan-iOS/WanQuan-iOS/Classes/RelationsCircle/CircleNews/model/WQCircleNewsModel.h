...
@class WQNeedsSecondaryReplyModel;

@interface WQCircleNewsModel : NSObject

@property (nonatomic, strong) WQNeedsSecondaryReplyModel *targetOperation;
...
/**
 如果是回复是主题的 id
 */
@property (nonatomic, copy) NSString * targetid2;

/**
 true string targetid的类型：TARGET_TYPE_MOMENT_STATUS=万圈状态； TARGET_TYPE_NEED=需求； TARGET_TYPE_GROUP=圈子； TARGET_TYPE_GROUP_TOPIC=圈子主题；
 */
